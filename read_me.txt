...
Notes:
    -Transfer over functions into new project.
    -Condense notebooks into parts I-IV above.
    -Clean-up and simplify notebooks.
    -Remove all references to local files to this folder.