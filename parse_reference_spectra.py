...
def output_loop(input_db,
    ...
    ref_dfs[0].to_pickle(output_path + 'ref_expt_df.pickle')
    ref_dfs[1].to_pickle(output_path + 'ref_theo_df.pickle')
    print(output_path + 'ref_expt_df.pickle', ' ', ref_dfs[0].shape)
    print(output_path + 'ref_theo_df.pickle', ' ', ref_dfs[1].shape)
